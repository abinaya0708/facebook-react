...
export const Createpost = () => {
    ...
    return <section className='createpost'>
        ...
        <div className='home1col'>
            <div className="home1img"><img src="https://dp-pic.com/wp-content/uploads/2024/01/A-Cute-Baby-Playing-on-Bed-Cute-Dp-by-DP-Pic-1.jpg" alt="pic"/></div>
        ...
        <div className='createimage'>
            {
                ...
                </div>:<div className='createimg'><img src={URL.createObjectURL(image)} alt="pic"/> </div>:
